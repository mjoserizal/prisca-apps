...
export default {
  ...
  setup() {
    ...
    const fetchApprovalRequests = () => {
      ...
      axios
        .get(
          "http://127.0.0.1:8000/api/userApproval/approvalRequest",
          config
        )
        .then((response) => {
    ...
    const handleApprovalApproved = (docCode, status) => {
      ...
      axios
        .post(
          `http://127.0.0.1:8000/api/userApproval/approvalRequest/${docCode}/accept`,
          payload,
          config
        )
        .then((response) => {
    ...
    const handleApprovalRejected = (docCode, status) => {
      ...
      axios
        .post(
          `http://127.0.0.1:8000/api/userApproval/approvalRequest/${docCode}/reject`,
          payload,
          config
        )
        .then((response) => {
