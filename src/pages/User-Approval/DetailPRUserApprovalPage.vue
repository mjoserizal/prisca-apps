    ...
    <q-card class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg" bordered>
      <q-card-section class="cart-header">
        <div class="text-h6 text-grey-8">
          Purchase Request Approval Details
        </div>
      </q-card-section>
        ...
        <div v-if="approvalDetails">
          <q-list bordered>
            <q-item>
              ...
              <q-item-section>
                <q-item-label>{{ approvalDetails.purchaseRequest.code }}</q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
          ...
          <div class="q-pa-md">
            ...
            <q-table :rows="approvalDetails.purchaseRequest.lineItems" :columns="lineItemColumns" row-key="id">
          ...
          <div class="q-pa-md">
            <div class="text-h6">Approval Requests</div>
            <q-table :rows="approvalDetails.approvalRequests" :columns="approvalRequestColumns" row-key="id">
      ...
      <q-card-section align="right">
        <router-link to="/purchase-request-approval">
