    ...
    const getProducts = async () => {
      try {
        ...
        const response = await axios.get(
          "http://192.168.1.244:8000/api/buyer/show/allProduct",
          config
        );
      ...
      `,
            ...
            <div class="comparison-details" style="display: flex; flex-direction: row;">
              <div class="product" style="padding: 10px;">
                <img src="${comparedProducts.value[0].thumbnail}" alt="${comparedProducts.value[0].title}" class="product-thumbnail" style="width: 400px; height: 200px;">
                <div class="product-details">
                  <p class="product-title">${comparedProducts.value[0].name}</p>
                  <p class="product-price">Price: $${comparedProducts.value[0].price}</p>
                  <p class="product-rating">Rating: ${comparedProducts.value[0].rating}</p>
                </div>
              </div>
              <div class="product" style="padding: 10px;">
                <img src="${comparedProducts.value[1].thumbnail}" alt="${comparedProducts.value[1].title}" class="product-thumbnail" style="width: 400px; height: 200px;">
                <div class="product-details">
                  <p class="product-title">${comparedProducts.value[1].name}</p>
                  <p class="product-price">Price: $${comparedProducts.value[1].price}</p>
                  <p class="product-rating">Rating: ${comparedProducts.value[1].rating}</p>
                </div>
              </div>
            </div>
          `,
